...
{
    public partial class HeaderGridView : DataGridView
    {
        ...
        public HeaderGridView(IContainer container)
        {
            container.Add(this);
        ...
        internal C1.Win.C1FlexGrid.CellRange GetCellRange(int i, int j)
        {
