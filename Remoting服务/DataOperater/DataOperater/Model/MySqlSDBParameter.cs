...
{
    [Serializable]
    public class MySqlSDBParameter
    {
        ...
        public MySqlSDBParameter(string parameterName, MySqlDbType dbType, int size)
        {
        ...
        public MySqlSDBParameter(string parameterName, MySqlDbType dbType, int size, object value)
        {
            if (parameterName != null)
            {
                this.parameterName = parameterName.Trim();
        ...
        public override bool Equals(object obj)
        {
            ...
            MySqlSDBParameter p = (MySqlSDBParameter)obj;
