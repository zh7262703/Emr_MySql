...
{
    public partial class ucTempratureEdit_Child : UserControl
    {
        printTemper_Child ph = new printTemper_Child();
        ...
        {
            Base_Function.TEMPERATURES.ucTempratureEdit_Child.tempPoints = new ArrayList();
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (isInArea(e.X, e.Y, d_x, d_y, d_w, d_h))
                    {
                        ...
                        frmTemperWrite_Child fc = new frmTemperWrite_Child(this.startTime, this.endTime, this.pid, this.id, this.bedno, selectdate);
                        fc.ShowDialog();
                        pictureBox1.Refresh();
                        return;
                    }
