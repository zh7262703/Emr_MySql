...
namespace TempertureEditor.Controls
{
    public class DataGridViewPrint
    {
        ...
        public DataGridViewPrint(DataGridView objDataGridView, PrintDocument objPrintDocument, bool bCenterOnPage, bool bHasTitle, string sTitle, Font objTitleFont, Color objTitleColor, bool bPaging)
        {
